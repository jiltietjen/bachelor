...
public class SinzParallelTest {
   ...
   * Solver solver = TestUtils.makeEncoding(2, 1, new SinzParallel(), ctx); // x_1 = true
   ...
   * SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(2, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * assertEquals(solver.check(), Status.SATISFIABLE); solver = TestUtils.makeEncoding(2, 1, new
   * SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1")); solver.add(ctx.mkBoolConst("x_2"));
   * assertEquals(solver.check(), Status.UNSATISFIABLE); // n = 3 r = 1 solver =
   * TestUtils.makeEncoding(3, 1, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   ...
   * SinzParallel(), ctx); solver.add(ctx.mkNot(ctx.mkBoolConst("x_1")));
   ...
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(3, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   ...
   * 4 r = 1 solver = TestUtils.makeEncoding(4, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   ...
   * SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_4"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 1, new SinzParallel(), ctx);
   ...
   * = TestUtils.makeEncoding(4, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   ...
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_4"))); assertEquals(solver.check(),
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(4, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkBoolConst("x_4"));
   * assertEquals(solver.check(), Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(4, 1, new
   * SinzParallel(), ctx); solver.add(ctx.mkNot(ctx.mkBoolConst("x_1")));
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkBoolConst("x_4")); assertEquals(solver.check(), Status.UNSATISFIABLE); solver
   * = TestUtils.makeEncoding(4, 1, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkBoolConst("x_4")); assertEquals(solver.check(), Status.UNSATISFIABLE); solver
   * = TestUtils.makeEncoding(4, 1, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   ...
   * TestUtils.makeEncoding(5, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(5, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkBoolConst("x_1")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(5, 1, new SinzParallel(), ctx);
   ...
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(5, 1, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(5, 1, new SinzParallel(), ctx);
   ...
   * = TestUtils.makeEncoding(5, 1, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   ...
   * solver.add(ctx.mkBoolConst("x_5")); assertEquals(solver.check(), Status.UNSATISFIABLE);
   * 
   * // n = 3 r = 2 solver = TestUtils.makeEncoding(3, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkBoolConst("x_1")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkBoolConst("x_3")); assertEquals(solver.check(), Status.SATISFIABLE); solver =
   * TestUtils.makeEncoding(3, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); assertEquals(solver.check(), Status.SATISFIABLE); solver =
   * TestUtils.makeEncoding(3, 2, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   ...
   * SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1")); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); assertEquals(solver.check(), Status.UNSATISFIABLE); // n =
   * 4 r = 2 solver = TestUtils.makeEncoding(4, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   ...
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_4"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * assertEquals(solver.check(), Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 2, new
   * SinzParallel(), ctx); solver.add(ctx.mkNot(ctx.mkBoolConst("x_1")));
   ...
   * TestUtils.makeEncoding(4, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * assertEquals(solver.check(), Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 2, new
   * SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   ...
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkBoolConst("x_4")); assertEquals(solver.check(), Status.UNSATISFIABLE); solver
   * = TestUtils.makeEncoding(4, 2, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkBoolConst("x_4")); assertEquals(solver.check(), Status.UNSATISFIABLE); solver
   * = TestUtils.makeEncoding(4, 2, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   ...
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_4"))); assertEquals(solver.check(),
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(4, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * assertEquals(solver.check(), Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 2, new
   * SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1")); solver.add(ctx.mkBoolConst("x_2"));
   ...
   * TestUtils.makeEncoding(5, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(5, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkBoolConst("x_1")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(5, 2, new SinzParallel(), ctx);
   ...
   * TestUtils.makeEncoding(5, 2, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_4"))); solver.add(ctx.mkBoolConst("x_5"));
   ...
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(5, 2, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkBoolConst("x_4"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(5, 2, new SinzParallel(), ctx);
   ...
   * solver.add(ctx.mkBoolConst("x_5")); assertEquals(solver.check(), Status.UNSATISFIABLE);
   * 
   * // n = 4 r = 3 solver = TestUtils.makeEncoding(4, 3, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   ...
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_4"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 3, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * assertEquals(solver.check(), Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 3, new
   * SinzParallel(), ctx); solver.add(ctx.mkNot(ctx.mkBoolConst("x_1")));
   ...
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkBoolConst("x_4")); assertEquals(solver.check(), Status.SATISFIABLE); solver =
   * TestUtils.makeEncoding(4, 3, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * assertEquals(solver.check(), Status.SATISFIABLE); solver = TestUtils.makeEncoding(4, 3, new
   * SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   ...
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkBoolConst("x_4")); assertEquals(solver.check(), Status.SATISFIABLE); solver =
   * TestUtils.makeEncoding(4, 3, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkBoolConst("x_3"));
   * solver.add(ctx.mkBoolConst("x_4")); assertEquals(solver.check(), Status.SATISFIABLE); solver =
   * TestUtils.makeEncoding(4, 3, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkBoolConst("x_2")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   ...
   * TestUtils.makeEncoding(5, 3, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(5, 3, new SinzParallel(), ctx);
   * solver.add(ctx.mkBoolConst("x_1")); solver.add(ctx.mkNot(ctx.mkBoolConst("x_2")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_4")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.SATISFIABLE); solver = TestUtils.makeEncoding(5, 3, new SinzParallel(), ctx);
   ...
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_3"))); solver.add(ctx.mkBoolConst("x_4"));
   * solver.add(ctx.mkBoolConst("x_5")); assertEquals(solver.check(), Status.SATISFIABLE); solver =
   * TestUtils.makeEncoding(5, 3, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_2"))); solver.add(ctx.mkNot(ctx.mkBoolConst("x_3")));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_4"))); solver.add(ctx.mkBoolConst("x_5"));
   ...
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkBoolConst("x_4"));
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_5"))); assertEquals(solver.check(),
   * Status.UNSATISFIABLE); solver = TestUtils.makeEncoding(5, 3, new SinzParallel(), ctx);
   * solver.add(ctx.mkNot(ctx.mkBoolConst("x_1"))); solver.add(ctx.mkBoolConst("x_2"));
   * solver.add(ctx.mkBoolConst("x_3")); solver.add(ctx.mkBoolConst("x_4"));
   * solver.add(ctx.mkBoolConst("x_5")); assertEquals(solver.check(), Status.UNSATISFIABLE); solver
   * = TestUtils.makeEncoding(5, 3, new SinzParallel(), ctx); solver.add(ctx.mkBoolConst("x_1"));
