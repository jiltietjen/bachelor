...
\section{Evaluation}
In diesem Abschnitt werden die Ergebnisse des Benchmarks präsentiert. Es wurden alle acht Kodierungen hinsichtlich ihres Speicher- und Zeidbedarfs für die unterschiedlichen Testprobleme untersucht. Die Testprobleme sind das n-Damen-Problem, Digital-Tomographys und synthetische Testfälle.\\
Das n-Damen-Problem ist eine schachmathematische Aufgabe. Es sollen n-Damen auf einem $nxn$-Feld platziert werden, so dass in jeder vertikalen, horizontalen und diagonalen Reihe nur eine Dame zu finden ist. 
...
%\DTLloaddb{test3}{ergebnisse_DigiTomo_Cats_KnuthBailleux.csv}
%\DTLloaddb{test4}{ergebnisse_SynthTests_KnuthBailleux.csv}

\begin{figure}[htbp]
\DTLplot{KnuthBailleux,KnuthSinz,NiklasseBDDs,SinzParallel,NOddEven,NOwn,NNaiv,Naiv}{x=k,y=endtime,style=lines,xticgap=10,minx=5,maxx=70,xticlabels={9,18,27,36,45,54,63,70},width=12cm,legend=northwest,linecolors={red,cyan,blue,orange,green,black,brown,purple},legendlabels={KnuthBailleux,KnuthSinz,NiklasseBDD,SinzParallel,NOddEven,NOwnSort,NNaiv,Naiv}}
\caption{Das n-Damen-Problem}
\end{figure}
...
\begin{figure}[htbp]
\DTLplot{KBailleux Cats,KSinz Cats,NikBDDs Cats,SinzParallel Cats,NOddEven Cats,NOwn Cats,NNaiv Cats,Naiv Cats}{x=k,y=endtime,style=lines,xticgap=0.2,minx=0.2,maxx=1.4,legend=northwest,linecolors={red,cyan,blue,orange,green,black,brown,purple},legendlabels={KnuthBailleux,KnuthSinz,NiklasseBDD,SinzParallel,NOddEven,NOwnSort,NNaiv,Naiv}}
\caption{Digital Tomography Cheshire Cats}
\end{figure}

\DTLloaddb{KnuthBailleux Syn}{ergebnisse_SynthTests_KnuthBailleux.csv}
\DTLloaddb{KnuthSinz Syn}{ergebnisse_SynthTests_KnuthSinz.csv}
\DTLloaddb{NiklasseBDDs Syn}{ergebnisse_SynthTests_NiklasseBDDs.csv}
\DTLloaddb{SinzParallel Syn}{ergebnisse_SynthTests_SinzParallel.csv}
\DTLloaddb{NOddEven Syn}{ergebnisse_SynthTests_NetworksOddEvenMergesort.csv}
\DTLloaddb{NOwn Syn}{ergebnisse_SynthTests_NetworksOwnSorting.csv}
\DTLloaddb{NNaiv Syn}{ergebnisse_SynthTests_NetworksNaiv.csv}
\DTLloaddb{Naiv Syn}{ergebnisse_SynthTests_Naiv.csv}%angepasst out of memory bei k=500

\begin{figure}[htbp]
\DTLplot{KnuthBailleux Syn,KnuthSinz Syn,NiklasseBDDs Syn,SinzParallel Syn,NOddEven Syn,NOwn Syn,NNaiv Syn,Naiv Syn}{x=k,y=endtime,style=lines,xticgap=625,minx=625,maxx=5000,xticlabels={625,1250,1875,2500,3125,3750,4375,5000},width=12cm,legend=northwest,linecolors={red,cyan,blue,orange,green,black,brown,purple},legendlabels={KnuthBailleux,KnuthSinz,NiklasseBDD,SinzParallel,NOddEven,NOwnSort,NNaiv,Naiv}}
\caption{Synthetische Testfälle}
\end{figure}
...
\begin{figure}[htbp]
\DTLplot{KnuthBailleux Klau,KnuthSinz Klau,NiklasseBDDs Klau,SinzParallel Klau,NOddEven Klau,NOwn Klau,NNaiv Klau,Naiv Klau}{x=k,y=numClauses,style=lines,xticgap=10,minx=5,maxx=70,xticlabels={9,18,27,36,45,54,63,70},width=12cm,legend=northwest,linecolors={red,cyan,blue,orange,green,black,brown,purple},legendlabels={KnuthBailleux,KnuthSinz,NiklasseBDD,SinzParallel,NOddEven,NOwnSort,NNaiv,Naiv}}
...
\begin{figure}[htbp]
\DTLplot{KnuthBailleux h klau,KnuthSinz h klau,NiklasseBDDs h klau,SinzParallel h klau,NOddEven h klau,NOwn h klau,NNaiv h klau,Naiv h klau}{x=k,y=numClauses,style=lines,xticgap=10,minx=5,maxx=70,xticlabels={9,18,27,36,45,54,63,70},width=12cm,legend=north,linecolors={red,cyan,blue,orange,green,black,brown,purple},legendlabels={KnuthBailleux,KnuthSinz,NiklasseBDD,SinzParallel,NOddEven,NOwnSort,NNaiv,Naiv}}
...
\begin{figure}[htbp]
\DTLplot{KnuthBailleux C klau,KnuthSinz C klau,NiklasseBDDs C klau,SinzParallel C klau,NOddEven C klau,NOwn C klau,NNaiv C klau,Naiv C klau}{x=k,y=numClauses,style=lines,xticgap=0.3,minx=0.6,maxx=3.0,xticlabels={0.6,0.9,1.2,1.5,1.8,2.1,2.4,2.7,3.0},legend=north,linecolors={red,cyan,blue,orange,green,black,brown,purple},legendlabels={KnuthBailleux,KnuthSinz,NiklasseBDD,SinzParallel,NOddEven,NOwnSort,NNaiv,Naiv}}
\caption{Digital Tomography Cheshire Cats mit der Anzahl der Klauseln}
\end{figure}

\DTLloaddb{KnuthBailleux S klau}{ergebnisse_SynthTests_KnuthBailleux-Kopie.csv}
\DTLloaddb{KnuthSinz S klau}{ergebnisse_SynthTests_KnuthSinz-Kopie.csv}
\DTLloaddb{NiklasseBDDs S klau}{ergebnisse_SynthTests_NiklasseBDDs-Kopie.csv}
\DTLloaddb{SinzParallel S klau}{ergebnisse_SynthTests_SinzParallel-Kopie.csv}
\DTLloaddb{NOddEven S klau}{ergebnisse_SynthTests_NetworksOddEvenMergesort-Kopie.csv}
\DTLloaddb{NOwn S klau}{ergebnisse_SynthTests_NetworksOwnSorting-Kopie.csv}
\DTLloaddb{NNaiv S klau}{ergebnisse_SynthTests_NetworksNaiv-Kopie.csv}
\DTLloaddb{Naiv S klau}{ergebnisse_SynthTests_Naiv-Kopie.csv}

\begin{figure}[htbp]
\DTLplot{KnuthBailleux S klau,KnuthSinz S klau,NiklasseBDDs S klau,SinzParallel S klau,NOddEven S klau,NOwn S klau,NNaiv S klau,Naiv S klau}{x=k,y=numClauses,style=lines,xticgap=625,minx=625,maxx=5000,xticlabels={625,1250,1875,2500,3125,3750,4375,5000},width=12cm,legend=northwest,linecolors={red,cyan,blue,orange,green,black,brown,purple},legendlabels={KnuthBailleux,KnuthSinz,NiklasseBDD,SinzParallel,NOddEven,NOwnSort,NNaiv,Naiv}}
